...
<div class="row">
	<div class="col-lg-3 col-md-3 col-sm-6 col-6">
		<div class="card card-widget widget-user-2">
          ...
          <div class="widget-user-header" style="background: url('<?php echo base_url() ?>assets/dist/img/photo1.png') center center;">
          ...
          <div class="card-footer">
            <i class="fa fa-map-marker-alt text-success"></i> Lokasi kota UMKM
          </div>
        </div>
	</div>
</div>
<div class="row">
  <div class="col-lg-12"><a href="#" class="btn btn-block btn-success">Lihat semua</a></div>
</div>